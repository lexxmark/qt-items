...
protected:
    ...
    bool initSpaceWidgetScrollable(SharedPtr<CacheSpace> mainCacheSpace, SharedPtr<CacheSpace> scrollableCacheSpace);
...
private:
    ...
    SharedPtr<CacheSpace> m_scrollableCacheSpace;
